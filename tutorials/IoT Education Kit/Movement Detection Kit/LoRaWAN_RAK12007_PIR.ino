...
#define TRIG WB_IO6
#define ECHO WB_IO4
#define PD   WB_IO5   //power done control ï¼ˆ=1 power doneï¼Œ=0 power onï¼‰ 

#define TIME_OUT  24125 //max measure distance is 4m,the velocity of sound is 331.6m/s in 0â„ƒ,TIME_OUT=4*2/331.6*1000000=24215us

float ratio = 346.6/1000/2;   //velocity of sound =331.6+0.6*25â„ƒ(m/s),(Indoor temperature about 25â„ƒ)
...
void loop()
{
  ...
  // long int duration, mm;
   ...
   if(duration > 0)
   {
     mm = duration*ratio; //Test distance = (high level timeÃ—velocity of sound (340M/S) / 2,
